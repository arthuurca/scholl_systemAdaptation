# PADRÃO SINGLETON: A classe Professor é usada em conjunto com o padrão Singleton
# Todos os cursores recebidos como parâmetro usam a conexão Singleton do banco de dados
# Isso garante consistência e eficiência em toda a aplicação
...
class Professor(Usuario):
    ...
    # PADRÃO SINGLETON: Implementação do contrato abstrato com conexão Singleton
    def get_dashboard_url(self):
        return "/dashboard_professor"
    
    # PADRÃO SINGLETON: O cursor aqui vem da conexão Singleton (veja app.py:conectar())
    ...
    # PADRÃO SINGLETON: O cursor aqui vem da conexão Singleton
